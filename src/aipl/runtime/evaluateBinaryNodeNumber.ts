import type { AiplNodeBinaryPrimitiveEvaluator } from "./AiplNodeEvaluator";
import { evaluateNodeToString } from "./evaluateNodeToString";

export const evaluateBinaryNodeToNumber: AiplNodeBinaryPrimitiveEvaluator<
  "identifier" | "stringLiteral",
  number
> = (context) => (left, right, node) => {
