...
import type { SdApiTxt2ImgRequest, SdApiTxt2ImgResponse } from "../../3rd/sdapi";
...
import type { AppCharacter, FormSkillConfig, ToolConfig } from "../app-character/AppCharacter";
...
export type AppMessageMap = {
    auth: string | (ReturnableMessageDetail & {
        userName?: string;
        password?: string;
    ...
    "dataObject:update:accessInfo": (DataObject & AccessInfo) | (DataObject & AccessInfo)[];
    "dataObject:get:accessInfo": ReturnableMessageDetail & {
        objectId: string;
    };
    "dataObject:murmur": DataObject | DataObject[];
    "dataObject:delete": string | string[];
    "dataObject:find": string | string[];
    "dataObject:get": ReturnableMessageDetail & {
        id: string | string[];
    };
    ...
    "dataObject:query": ReturnableMessageDetail & {
        query: string;
    };
    ...
    "app:reset": unknown;
    "app:setAlarm": number;
    "app:group:create": ReturnableMessageDetail & {
    ...
    "aipl:exec": ReturnableMessageDetail & StreamableMessageDetail & {
