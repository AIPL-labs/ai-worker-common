...
export declare const isAiplProgramAstNode: (maybe: unknown) => maybe is AiplAstSpec["program"];
export type AiplAstSpec = {
    ...
    binaryExpr: {
        ...
        left: AiplAstSpec["expr" | "identifier" | "number" | "unaryExpr" | "stringLiteral"];
        right: AiplAstSpec["expr" | "identifier" | "number" | "unaryExpr" | "stringLiteral"];
        loc: AiplLoc;
    };
    code: {
        type: "code";
    ...
    program: {
        type: "program";
        value: AiplAstSpec["escapedSymbol" | "comment" | "multilineComment" | "apply" | "assignment" | "directAssignment" | "text" | "templateVariable" | "code"][];
        loc: AiplLoc;
    };
};
export {};
