...
export type AiplNodeBinaryPrimitiveEvaluator<T extends AiplNodeType, V> = (context: Readonly<AiplContext>) => (left: AiplAstSpec[T], right: AiplAstSpec[T], expr: AiplAstSpec["binaryExpr"]) => V;
